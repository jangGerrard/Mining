...
Timeline.GregorianEtherPainter.prototype.paint = function() {
    ...
    var minYearStr = minDate.toString();
    var res = minYearStr.split(" ");
    var minYear = parseInt(res[3]);
    var maxYearStr = maxDate.toString();
    res = maxYearStr.split(" ");
    var maxYear = parseInt(res[3]);
    
    var midYear = (minYear + maxYear) / 2;
    
//    alert('parentNode : '+this._markerLayer.parentNode);
    var tl = this._markerLayer.parentNode.parentNode.parentNode.parentNode;
    if(tl != null){
    	var eventSource = this._band.getEventSource(); //getEventSource
//    	this._band.ge
    	if(midYear > 1800){
    		this._band.intervalUnit = Timeline.DateTime.YEAR;
    	}else{
    		this._band.intervalUnit = Timeline.DateTime.DECADE;
    	}
    	
//    	alert('painter person : '+this._band.getPerson());
    	var classify = this._band.getPerson()
    	 Timeline.loadJSON("koreanTimeLine.do?yearSelection="+midYear+'&classify='+classify, function(json, url) {
//    		 alert('url : '+url+'\njson : '+json);
//    		 alert(eventSource);
...
//    	var d = Timeline.DateTime.parseGregorianDateTime(midYear);
//    	var bandInfos = [
...
//    	
//    	
//    	var tl = Timeline.create(this._markerLayer.parentNode.parentNode.parentNode.parentNode, bandInfos, Timeline.HORIZONTAL);
//    	
//	    tl.loadJSON("koreanTimeLine.do?yearSelection="+midYear, function(json, url) {
//	        eventSource.loadJSON(json, url);
//	    });
//    }
    flag++;
