...
/*
 * added by jang 151109
 * */
Timeline._Band.prototype.getPerson = function() {
    return this.person;
};

Timeline._Band.prototype.setPerson = function(p) {
    this.person = p;
};
...
Timeline._Band.prototype._onMouseMove = function(innerFrame, evt, target) {
    if (this._dragging) {
        ...
        this._bandInfo.etherPainter.redrawLinesAndMarkers();
...
Timeline._Band.prototype.setPosition = function(minDate, maxDate, centerDate, zoomLevel, viewOffsetY) {
    ...
    this.setMinVisibleDate(Timeline.DateTime.parseGregorianDateTime(minDate));
    this.setMaxVisibleDate(Timeline.DateTime.parseGregorianDateTime(maxDate));
    this.setCenterVisibleDate(Timeline.DateTime.parseGregorianDateTime(centerDate));
    this.paint();
